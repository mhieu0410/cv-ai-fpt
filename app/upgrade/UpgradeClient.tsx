    ...
    <div className="min-h-screen bg-zinc-950 py-12 px-4 flex flex-col items-center">
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Pro card */}
          <div className="bg-zinc-900 border border-violet-500/50 rounded-2xl p-6 flex flex-col relative shadow-[0_0_30px_rgba(139,92,246,0.15)]">
            <span className="absolute top-4 right-4 text-xs font-semibold text-violet-300 bg-violet-950/80 px-2.5 py-0.5 rounded-full border border-violet-700">
              Đề xuất
            </span>
            <p className="text-violet-400 text-sm font-medium uppercase tracking-wide mb-1">Pro 1 tháng</p>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 rounded-lg bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
